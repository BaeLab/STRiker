...
# def find_motif_sequence2(text, motifs):
#     """문자열에서 알려진 motif들의 순서와 횟수를 찾는 함수"""
#     # motif를 길이 순으로 정렬 (긴 것부터)
#     sorted_motifs = sorted(motifs, key=len, reverse=True)
...
#             current_count += 1
#         else:
#             if current_motif and current_count > 1:
#                 consecutive_patterns.append((current_motif, current_count))
#             current_motif = motif
#             current_count = 1
...
#     return motif_counts, consecutive_patterns
...
# text = "CT"*3 + "GAA"*2 + "GAAGCAGAA"*2 + "GAA"*2 + "GAAGCAGAA"*2 + "GAA"*2 + "GAAGCAGAACCGAAGGAAGAAGCAGAA"
...
# counts, patterns = analyze_motif_usage(sequence)
...
# print(f"\n=== 연속 반복 패턴 ===")
# if patterns:
#     for motif, count in patterns:
#         print(f"'{motif}' {count}번 연속")
# else:
#     print("연속 반복 패턴 없음")
